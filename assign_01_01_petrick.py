...
# This program will calculate the Net Income of a company based on the user's input of Net Sales, Cost of Goods Sold, Operating Expenses, Depreciation/Amortization, Interest Expenses, and Tax Rate.
